cmd_arch/arm/boot/compressed/head-str8131.o := /opt/codesourcery/arm-2010q1/bin/arm-none-eabi-gcc -Wp,-MD,arch/arm/boot/compressed/.head-str8131.o.d  -nostdinc -isystem /opt/codesourcery/arm-2010q1/bin/../lib/gcc/arm-none-eabi/4.4.1/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -mlittle-endian -D__ASSEMBLY__ -mabi=apcs-gnu -mno-thumb-interwork -D__LINUX_ARM_ARCH__=4 -march=armv4 -mtune=arm9tdmi -msoft-float    -c -o arch/arm/boot/compressed/head-str8131.o arch/arm/boot/compressed/head-str8131.S

deps_arch/arm/boot/compressed/head-str8131.o := \
  arch/arm/boot/compressed/head-str8131.S \
...
arch/arm/boot/compressed/head-str8131.o: $(deps_arch/arm/boot/compressed/head-str8131.o)
