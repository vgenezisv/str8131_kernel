cmd_drivers/ide/arm/str8131-ide.o := /opt/codesourcery/arm-2010q1/bin/arm-none-eabi-gcc -Wp,-MD,drivers/ide/arm/.str8131-ide.o.d  -nostdinc -isystem /opt/codesourcery/arm-2010q1/bin/../lib/gcc/arm-none-eabi/4.4.1/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -mlittle-endian -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O3  -falign-functions=16    -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mabi=apcs-gnu -mno-thumb-interwork -D__LINUX_ARM_ARCH__=4 -march=armv4 -mtune=arm9tdmi  -msoft-float -Uarm -Wdeclaration-after-statement -Wno-pointer-sign -funit-at-a-time -Idrivers/ide   -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(str8131_ide)"  -D"KBUILD_MODNAME=KBUILD_STR(str8131_ide)" -c -o drivers/ide/arm/str8131-ide.o drivers/ide/arm/str8131-ide.c

deps_drivers/ide/arm/str8131-ide.o := \
  drivers/ide/arm/str8131-ide.c \
  ...
  include/linux/ata.h \
  include/linux/ide.h \
    $(wildcard include/config/blk/dev/ide/str8131.h) \
...
drivers/ide/arm/str8131-ide.o: $(deps_drivers/ide/arm/str8131-ide.o)
