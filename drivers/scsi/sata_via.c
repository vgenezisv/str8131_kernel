...
#if defined(CONFIG_ARCH_STR9100) || defined(CONFIG_ARCH_STR8131)
	scr_addr = (unsigned long)ioremap(vt6421_scr_addr(pci_resource_start(pdev, 5), port),pci_resource_len(pdev, 5));
#else
